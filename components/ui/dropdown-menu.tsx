...
// Shared by DropdownMenuItem and DropdownMenuLinkItem so a link in a menu is
// styled by the same string as a button in one, not by a copy of it that can
// drift when the shadcn CLI regenerates this file.
const ITEM_CLASSES =
